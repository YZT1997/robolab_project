...
if("TRUE" STREQUAL "TRUE")
  set(talker_SOURCE_PREFIX /home/yangzt/catkin_ws/src/talker)
  set(talker_DEVEL_PREFIX /home/yangzt/catkin_ws/src/cmake-build-debug/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'talker' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yangzt/catkin_ws/src/talker/${idir}'.  ${_report}")
    endif()
