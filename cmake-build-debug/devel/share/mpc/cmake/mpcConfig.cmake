...
if("TRUE" STREQUAL "TRUE")
  set(mpc_SOURCE_PREFIX /home/yangzt/catkin_ws/src/mpc)
  set(mpc_DEVEL_PREFIX /home/yangzt/catkin_ws/src/cmake-build-debug/devel)
  set(mpc_INSTALL_PREFIX "")
  set(mpc_PREFIX ${mpc_DEVEL_PREFIX})
else()
  set(mpc_SOURCE_PREFIX "")
  set(mpc_DEVEL_PREFIX "")
  set(mpc_INSTALL_PREFIX /usr/local)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'sunh <sunh@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mpc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yangzt/catkin_ws/src/mpc/${idir}'.  ${_report}")
    endif()
