...
if("TRUE" STREQUAL "TRUE")
  set(read_CAN_SOURCE_PREFIX /home/yangzt/catkin_ws/src/read_CAN)
  set(read_CAN_DEVEL_PREFIX /home/yangzt/catkin_ws/src/cmake-build-debug/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'read_CAN' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yangzt/catkin_ws/src/read_CAN/${idir}'.  ${_report}")
    endif()
